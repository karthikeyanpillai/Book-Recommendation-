# -*- coding: utf-8 -*-
"""
Created on Fri Aug 11 11:39:28 2023
...
popular = pd.read_pickle('C:/Users/Opstech Demo/Desktop/DataScience/ExcelrProjects/recommendationP270/popular.pkl')
similarity_score = pd.read_pickle('C:/Users/Opstech Demo/Desktop/DataScience/ExcelrProjects/recommendationP270/smilarity_scores_saved')
pt = pd.read_pickle('C:/Users/Opstech Demo/Desktop/DataScience/ExcelrProjects/recommendationP270/users_pt')
books = pd.read_pickle("C:/Users/Opstech Demo/Desktop/DataScience/ExcelrProjects/recommendationP270/books.pkl")

def web_recommend(book_name):
    # index fetch
...
def main():
    ...
    if st.sidebar.button("Recommend Me"):
        moviee = web_recommend(selected_book)
        col1, col2, col3, col4, col5 = st.columns(5)
        with col1:
            st.image(moviee[0][2])
            st.text(moviee[0][0])
